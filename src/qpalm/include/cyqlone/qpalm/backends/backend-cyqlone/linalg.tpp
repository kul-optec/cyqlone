...
void CyqloneBackend<VL, DefaultOrder>::xaxpy(Context &ctx, real_t a, const T &x, U &y) {
...
template <index_t VL, StorageOrder DefaultOrder>
template <class T, class U>
void CyqloneBackend<VL, DefaultOrder>::xcopy(Context &ctx, const T &x, U &y) const {
...
template <index_t VL, StorageOrder DefaultOrder>
template <class T, class U>
void CyqloneBackend<VL, DefaultOrder>::set_constant(Context &ctx, T &x, const U &y) const {
...
template <index_t VL, StorageOrder DefaultOrder>
template <class T>
void CyqloneBackend<VL, DefaultOrder>::scale(Context &ctx, real_t s, T &x) const {
    const auto scale = [&](auto, auto, auto xi) { linalg::axpy<0>(s, xi, xi); };
    ocp.foreach_stage(ctx, scale, x);
}

template <index_t VL, StorageOrder DefaultOrder>
real_t CyqloneBackend<VL, DefaultOrder>::dot(Context &ctx, const var_vec_t &a,
...
template <index_t VL, StorageOrder DefaultOrder>
template <class... Args>
void CyqloneBackend<VL, DefaultOrder>::local_dots(std::span<real_t, 1 + sizeof...(Args) / 2> out,
...
CyqloneBackend<VL, DefaultOrder>::dots(Context &ctx, const Args &...args) const {
...
template <index_t VL, StorageOrder DefaultOrder>
template <class T>
real_t CyqloneBackend<VL, DefaultOrder>::norm_inf(Context &ctx, const T &x) const {
    using std::isfinite;
...
template <index_t VL, StorageOrder DefaultOrder>
template <class T>
real_t CyqloneBackend<VL, DefaultOrder>::norm_squared(Context &ctx, const T &x) const {
    real_t sumsq            = 0;
