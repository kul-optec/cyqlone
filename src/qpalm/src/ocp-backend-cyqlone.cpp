...
BATMAT_FOREACH_VL_DEFAULT(CYQLONE_INSTANTIATE_QPALM_Cyqlone, StorageOrder::ColMajor)
BATMAT_FOREACH_VL_DEFAULT(CYQLONE_INSTANTIATE_QPALM_Cyqlone, StorageOrder::RowMajor)
